...
import 'package:landing_page/src/updProyectos/services/updproyecto_service.dart';

class UpdProyectosPage extends StatefulWidget {
  final String nombre;
  ...
  @override
  State<UpdProyectosPage> createState() => _UpdProyectosPageState();
}

class _UpdProyectosPageState extends State<UpdProyectosPage> {
  ...
  Widget build(BuildContext context) {
    ...
    _textController1.text = widget.nombre;
    _textController2.text = widget.descripcion;
    _textController3.text = widget.grupo;
    _textController4.text = widget.integrantes;
    _textController5.text = widget.imagen;
    return Scaffold(
          ...
          child: ElevatedButton(
            ...
            onPressed: () async {
              if (_textController1.text.isNotEmpty &&
                ...
                await updProyecto(widget.uid, _nombre, _descripcion,
                    _integrantes, _grupo, _imagen);

                showDialog(
                  context: context,
                  builder: (BuildContext context) {
                    return AlertDialog(
                      title: const Text('Se ha actualizado correctamente'),
                      actions: [
                        TextButton(
                          onPressed: () {
